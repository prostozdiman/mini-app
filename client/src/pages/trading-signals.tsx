        ...
        {currentScreen === 'pairs' && (
          <div className="container mx-auto px-4 py-6 animate-slide-up">
            ...
            <div className="text-center space-y-3">
              ...
              <div className="bg-gray-900/30 p-3 rounded-lg border border-gray-700/30 mt-4">
                <div className="text-center mb-2">
                  <div className="text-yellow-400 font-bold text-sm">🎯 AI TRADING SIGNALS</div>
                  <div className="text-gray-400 text-xs mt-1">
                    94.7% Accuracy • 50,000+ Traders • Real-time Analysis
                  </div>
                </div>
                ...
                <div className="flex justify-center items-center space-x-3 text-xs">
                  ...
                  <div className="flex items-center space-x-1">
                    ...
                    <span className="text-cyan-400">AI ON</span>
                  </div>
                  <div className="flex items-center space-x-1">
